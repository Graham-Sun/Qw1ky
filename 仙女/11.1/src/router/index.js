        ...
        children: [
            {
                ...
                redirect: "/aSingleAnalysis/aSingleList",
                component: () => import("@/view/aSingleAnalysis/index.vue"),
                children: [{
                        id: "/aSingleList",
                        path: 'aSingleList',
                        name: "ASingleAnalysis_ASingleList",
                        component: () => import("@/view/aSingleList/index.vue"),
                    },
                    {
                        id: "/createAnalyse",
                        path: 'createAnalyse',
                        name: "ASingleAnalysis_CreateAnalyse",
                        component: () => import("@/view/createAnalyse/index.vue"),
                    },
                    {
                        id: "/aSingleComplete",
                        path: 'aSingleComplete',
                        name: "ASingleAnalysis_ASingleComplete",
                        component: () => import("@/view/aSingleComplete/index.vue"),
                    },
                ]
            },
            {
